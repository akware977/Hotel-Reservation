(function ($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<a href='/index' class='logo-mobile-menu'><img src='assets/img/mobile-logo.png' /></a>"});
    ...
    if ($('#googleMap').length) {
        ...
        var initialize = function () {
            var mapOptions = {
                zoom: 15,
                scrollwheel: false,
                center: new google.maps.LatLng(-7.81618, 154.95692),
                styles: [{
                    stylers: [{
                      saturation: -100
                    }]
